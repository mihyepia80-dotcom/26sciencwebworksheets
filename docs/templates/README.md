# 수업 설계·활동지 원본 (한글 → Markdown)

| 파일 | 원본 hwpx | 설명 |
|------|-----------|------|
| [01-lesson-plan-template.md](./01-lesson-plan-template.md) | `1.지도안(틀).hwpx` | 교사용 지도안 설계 틀 |
| [02-experiment-class-lesson-plan.md](./02-experiment-class-lesson-plan.md) | `2. 실험반 지도안.hwpx` | 용해와 용액 단원 실험반 지도안 전체 (자동 추출) |
