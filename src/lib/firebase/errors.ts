const AUTH_ERROR_MESSAGES: Record<string, string> = {
  ...
  "auth/operation-not-allowed": "Firebase Authentication에서 Google 로그인을 활성화해 주세요.",
  "auth/admin-restricted-operation": "Google 로그인이 제한되어 있습니다. Firebase Console → Authentication → Google을 확인해 주세요.",
  "auth/access-denied": "Google 로그인이 거부되었습니다. OAuth 앱 테스트 사용자 제한이 있으면 승인된 Google 계정으로 시도해 주세요.",
